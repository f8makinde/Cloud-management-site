            ...
            <div className='max-w-[1240px] mx-auto text-white relative'>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-3 relative gap-x-8 gap-y-16 px-4 pt-12 sm:pt-20 text-black'>
                    <div className='bg-white rounded-xl shadow-2xl'>
                        <div className='p-8'>
                            <FaPhoneAlt className='w-16 text-indigo-600 text-white rounded-lg mt-[4rem]' size={30}/>
                        ...
                        <div className='mx-4 bg-slate-100 pl-8 py-4'>
                            <p className='flex items-center text-indigo-600'>Contact Us <FaArrowRight className='w-5 ml-2'/></p>
                        </div>
                    </div>
                    <div className='bg-white rounded-xl shadow-2xl pb-8'>
                        <div className='p-8'>
                            <MdSupport className='w-16 text-indigo-600 text-white rounded-lg mt-[4rem]' size={30}/>
                    ...
                    <div className='bg-white rounded-xl shadow-2xl'>
                        <div className='p-8'>
                            <BiChip className='w-16 text-indigo-600 text-white rounded-lg mt-[4rem]' size={30}/>
